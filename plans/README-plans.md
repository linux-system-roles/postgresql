...
Linux System Roles CI runs [tmt](https://tmt.readthedocs.io/en/stable/index.html) test plans in [Testing farm](https://docs.testing-farm.io/Testing%20Farm/0.1/index.html) with the [tft.yml](https://github.com/linux-system-roles/postgresql/blob/main/.github/workflows/tft.yml) GitHub workflow.
...
The [tft.yml](https://github.com/linux-system-roles/postgresql/blob/main/.github/workflows/tft.yml) workflow runs the above plan and uploads the results to our Fedora storage for public access.
...
5. Enter `testing-farm request`.
    ...
    $ TESTING_FARM_API_TOKEN=<your_api_token> \
        ...
        --git-url "https://github.com/<my_user>/postgresql" \
        --git-ref "<my_branch>" \
